			...
			<div class="wc-pc13-primary-actions">
				...
				<div class="wc-pc13-download-actions-primary">
					...
					<button type="button" class="button button-secondary wc-pc13-download-pdf">
						<span class="wc-pc13-pdf-text"><?php esc_html_e( 'Télécharger en PDF HD', 'wc-photo-clock-13' ); ?></span>
						<span class="wc-pc13-pdf-spinner" style="display: none; width: 12px; height: 12px; border: 2px solid #ffffff; border-top-color: transparent; border-radius: 50%; animation: wc-pc13-spin 1s linear infinite; margin-left: 8px;"></span>
					</button>
				</div>
			</div>
